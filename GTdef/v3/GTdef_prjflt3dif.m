function [ newflt,prjflt,xyzctr,xyztop1 ] = GTdef_prjflt3dif(flt,subflt,dipin)
...
% last modified by Lujia Feng Wed Jun 13 15:57:42 SGT 2012                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[ prjflt,xyzctr,xyztop1 ] = GTdef_prjflt3uni(newflt);
