function [ modspace,xyzflt,Xgrn ] = GTdef_fault4dif(modspace,flt,subflt,dipin,strin,Xin,Bin,Nin,earth)
...
% last modified by Lujia Feng Tue Jun 23 13:08:07 SGT 2015                     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if subflt_num==1
    ...
    [ xyzflt,Xgrn,Bgrn,Ngrn,sm,Aeq,beq,lb,ub,x0 ] = GTdef_fault4uni(earth,[flt(:,1:end-2)],xyzflt,Xin,Bin,Nin);
    sm_abs = [];
    sm     = [];
...
[ xyzflt,Xgrn,Bgrn,Ngrn,sm,Aeq,beq,lb,ub,x0 ] = GTdef_fault4uni(earth,newflt,xyzflt,Xin,Bin,Nin);
