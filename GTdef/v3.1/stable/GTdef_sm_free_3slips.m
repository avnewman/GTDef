function [ sm_1d3pf,sm_1d3pb,sm_2d,sm_abs ] = GTdef_sm_free_3slips(dd,ds,Nd,Ns)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                        GTdef_sm_free_3slips				  %
...
% changed from GTdef_sm_free.m to GTdef_sm_free_3slips.m lfeng May 2012   %
