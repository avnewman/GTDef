function [ modspace,xyzflt,Xgrn ] = GTdef_fault4dif(modspace,...
...
% added xyzflt.compnum for generating sm lfeng Thu Jun 16 23:19:54 SGT 2016      %
% last modified by Lujia Feng Thu Jun 16 23:20:06 SGT 2016                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if subflt_num==1
    ...
    [ ~,xyzflt ] = GTdef_prjflt4uni(prjflt);

    [ xyzflt,Xgrn,Lgrn,Bgrn,Ngrn,sm,Aineq,bineq,Aeq,beq,lb,ub,x0 ] = GTdef_fault4uni(earth,[flt(:,1:end-2)],xyzflt,Xin,Lin,Bin,Nin);
    sm_abs = [];
    sm     = [];
...
if isempty(strin)
    ...
    if colsum ~= Ns, error('GTdef_fault4diff ERROR: strike is not specified correctly!'); end
...
[ xyzflt,Xgrn,Lgrn,Bgrn,Ngrn,sm,Aineq,bineq,Aeq,beq,lb,ub,x0 ] = GTdef_fault4uni(earth,newflt,xyzflt,Xin,Lin,Bin,Nin);
