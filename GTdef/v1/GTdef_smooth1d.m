function [ sm ] = GTdef_smooth1d(dd,ds,Nd,Ns)
...
% The equation used here for the first-order derivatives is		  %
%  Si-1,j - 2Si,j + Si+1,j	 Si,j-1 - 2Si,j + Si,j+1		  %
% -------------------------  +  -------------------------		  %
%            dx				   dy				  %
%								 	  %
% related function: GTdef_smooth2d()					  %
% first created by Lujia Feng Fri May  8 17:53:25 EDT 2009		  %
% last modified by Lujia Feng Fri May  8 18:03:20 EDT 2009		  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

nn = Ns*Nd;			% total patch/slip number
mx = 1/ds; 			% the patches on left and right
my = 1/dd;			% the patches on top and bottom
