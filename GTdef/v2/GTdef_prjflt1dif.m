function [ newflt,prjflt,xyzctr,xyztop1 ] = GTdef_prjflt1dif(flt,subflt,dipin)
...
% last modified by Lujia Feng Wed Jun 13 15:53:54 SGT 2012                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[ prjflt,xyzctr,xyztop1 ] = GTdef_prjflt1uni(newflt);
