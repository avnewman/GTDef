function [ newflt,prjflt,xyzctr,xyztop1 ] = GTdef_prjflt2dif(flt,subflt,dipin)
...
% last modified by Lujia Feng Wed Jun 13 15:56:35 SGT 2012                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[ prjflt,xyzctr,xyztop1 ] = GTdef_prjflt2uni(newflt);
