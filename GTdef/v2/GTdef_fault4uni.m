function [ Xgrn,Bgrn,Ngrn,sm,Aeq,beq,lb,ub,x0,Min0 ] = GTdef_fault4uni(flt,Xin,Bin,Nin,earth,mu,nu,edgrn,edgrnfcts)
...
% last modified by Lujia Feng Thu May 17 08:57:52 SGT 2012                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
