...
%    strain   - average strain of each patch 				  %
...
% last modified by Lujia Feng Wed Dec  9 16:53:14 EST 2009		  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ~isempty(sm)
    ...
    if strcmp(smooth,'2d')
        ...
        r_1d = 1e5*0.25*sm_all/sm_num;				% NOTE: roughness [cm/km]; 0.5 accounts for both ds and ss and twice smoothing (two directions)
	r_2d = nan;
    end
end
if ~isempty(sm_abs)
    ...
    sm_num = size(sm_abs,1);
    	strain = 1e5*sm_all/sm_num;				% NOTE: roughness [cm/km^2]; 0.5 accounts for both ds and ss
else
    strain = nan;
end
