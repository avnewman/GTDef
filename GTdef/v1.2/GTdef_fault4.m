function [ Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0 ] = GTdef_fault4(flt,subflt,dipin,Xin,Bin,Nin,mu,nu,smooth,fsurf)
...
% last modified by Lujia Feng Wed Dec  9 16:16:52 EST 2009		  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
