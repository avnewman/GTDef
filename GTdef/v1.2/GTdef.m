...
% last modified lfeng Fri Dec 11 22:38:23 EST 2009			  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tic
	...
	GTdef_fault3([x3(ii) y3(ii) flt3(ii,3:end)],subflt(sub_ind,:),dip(dip_ind,:),pnt_crt,bsl_crt,nod_crt,rigidity,poisson,smooth,fsurf);
...
tic
	...
	GTdef_fault4([x4_1(ii) y4_1(ii) x4_2(ii) y4_2(ii) flt4(ii,5:end)],subflt(sub_ind,:),dip(dip_ind,:),pnt_crt,bsl_crt,nod_crt,rigidity,poisson,smooth,fsurf);
    	[ Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0 ] = ...
	GTdef_addall(Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0,...
	             Xgrn4,Bgrn4,Ngrn4,sm4,sm4_abs,Aeq4,beq4,lb4,ub4,x04);
    end
...
tic
	...
	GTdef_fault5(flt5,subflt(sub_ind,:),bndry(bnd_ind,:),pnt_crt,bsl_crt,nod_crt,rigidity,poisson,smooth,fsurf);
    	[ Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0 ] = ...
	GTdef_addall(Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0,...
	             Xgrn5,Bgrn5,Ngrn5,sm5,sm5_abs,Aeq5,beq5,lb5,ub5,x05);
    end
...
tic
    ...
    GTdef_output(fout_name,0,0,0,rigidity,poisson,flt1_name,flt1_num,flt1,flt2_name,flt2_num,flt2,flt3_name,flt3_num,flt3,...
...
fprintf(1,'\n............. doing inversion .............\t');
	...
	% output results
        GTdef_output(fout_name,bt,smooth,fsurf,rigidity,poisson,flt1_name,flt1_num,flt1_out,flt2_name,flt2_num,flt2_out,flt3_name,flt3_num,flt3,...
              	     flt4_name,flt4_num,flt4,flt5_name,flt5_num,flt5,bndry_name,bndry,...
