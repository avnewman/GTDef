function [ Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0 ] = GTdef_fault3(flt,subflt,dipin,Xin,Bin,Nin,mu,nu,smooth,fsurf)
...
% last modified by Lujia Feng Wed Dec  9 16:56:38 EST 2009		  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
