function [ Xgrn,Bgrn,Ngrn,sm,sm_abs,Aeq,beq,lb,ub,x0 ] = GTdef_fault5(flt,subflt,bndry,Xin,Bin,Nin,mu,nu,smooth,fsurf)
...
% last modified by Lujia Feng Fri Dec 11 15:01:07 EST 2009		  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if fsurf==1
    ...
    [ sm_1d3pf,sm_1d3pb,sm_2d,sm_abs ] = GTdef_sm(ddip,dlen,Nd,Ns);
end
