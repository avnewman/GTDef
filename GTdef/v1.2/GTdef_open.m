function [ coord,smooth,fsurf,beta,rigidity,poisson,...
...
% (1) Parameters: coord         scalar                  {1}			%
%                      1 - geographic coordiante				%
...
%                 fsurf       free-surface		{0}			%
%                      0 - no free surface					%
% 		       1 - assume free-surface					%
%                 kappa 	(1*kappa_num)		{0}			%
%                 beta 		(1*beta_num)		{0}			%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Controlling Variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if strcmp(flag,'coord')
 	[ coord,remain ] = GTdef_read1double(remain);
	continue
    end
    %%%%% smoothing algorithm %%%%%
    ...
    %%%%% free surface flag %%%%%
    if strcmp(flag,'freesurface')
	[fsurf,remain] = strtok(remain);
	continue
    end
    %%%%% kappa %%%%%
