function [ sm ] = GTdef_sm1d_3pbwd_uprt(dd,ds,Nd,Ns)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                       GTdef_sm1d_3pbwd_uprt				  %
% This file is actually the same as GTdef_sm1d_3pbwd_uprt_free.m	  %
...
% (right is x+; up is y+)					  	  %
%								 	  %
% first created by Lujia Feng Wed Dec  9 20:09:45 EST 2009		  %
% last modified by Lujia Feng Wed Dec  9 20:12:04 EST 2009		  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
