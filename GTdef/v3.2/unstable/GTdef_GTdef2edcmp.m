...
% origin coordinates are not used                                         %
...
% last modified by Lujia Feng Wed Apr 27 23:13:36 SGT 2016                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if pnt.num~=0
    ...
    fprintf(fout,'  %d\n ',pnt.num);
    for ii=1:pnt.num-1
        fprintf(fout,' (%f,%f),',pyy(ii),pxx(ii));  % switch x & y (GTdef:x-east;y-north; edcmp:x-north;y-east)
    end
    fprintf(fout,' (%f,%f)\n',pyy(end),pxx(end));
end
toc
...
if ~isempty(newflt34)
    ...
    fprintf(fout,'#-------------------------------------------------------------------------------\n');
    for ii =1:subflt_num
        fprintf(fout,'  %-3d %12.6f  %-12.5e %-11.5e %-12.5e  %-11.5e %-12.5e %-8.5f  %-5.1f %-5.1f\n',...
