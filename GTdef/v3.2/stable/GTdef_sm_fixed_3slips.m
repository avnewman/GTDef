function [ sm_1d3pf,sm_1d3pb,sm_2d,sm_abs ] = GTdef_sm_fixed_3slips(dd,ds,Nd,Ns)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                           GTdef_sm_fixed_3slips			  %
...
%   take into account three components (strike, dip, and tensile)	  %
%									  %
% first created by Lujia Feng Thu Dec  3 00:23:51 EST 2009		  %
% changed from GTdef_sm.m to GTdef_sm_fixed.m lfeng Wed Feb 24  2010	  %
% changed from GTdef_sm_fixed.m to GTdef_sm_fixed_3slips.m lfeng May 2012 %
