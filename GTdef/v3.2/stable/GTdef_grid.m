...
%                                                                                   %
% OUTPUT:                                                                           %
%  x_grd - column vector for x values of the grid nodes			            %
%  y_grd - column vector for y values of the grid nodes			            %
%                                                                                   %
...
% last modified by Lujia Feng Mon Jul 27 15:58:29 SGT 2015                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
