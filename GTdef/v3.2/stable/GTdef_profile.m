...
%                                                                                   %
% OUTPUT:                                                                           %
%  x_prf - column vector for x values of the profile nodes                          %
%  y_prf - column vector for y values of the profile nodes                          %
%                                                                                   %
...
% output column vectors instead of row vectors lfeng Mon Jul 27 15:52:29 SGT 2015   %
% last modified by Lujia Feng Mon Jul 27 15:53:36 SGT 2015                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
