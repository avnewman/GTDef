function [ newflt,prjflt,xyzflt ] = GTdef_prjflt4dif(flt,subflt,dipin,strin)
...
% last modified by Lujia Feng Tue Mar 24 13:08:51 SGT 2015                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[ prjflt,xyzflt ] = GTdef_prjflt4uni(newflt);
